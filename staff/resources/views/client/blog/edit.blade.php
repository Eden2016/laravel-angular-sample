            ...
            <form method="POST">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{route('client.blog.delete', [$post->id])}}" class="btn btn-danger">
                ...
                <script type="text/javascript">
                  $(document).ready(function() {
                    ...
                    function getTranslation(lang) {
                      $('#te_lang').val(lang);
                      $.ajax({
                        url: '{{groute('client.blog.post.translation', [$post->id, ''])}}/' + lang,
                        type: 'GET',
                        dataType: 'json',
                    ...
                    $('#saveTranslation').click(function(){
                      $.ajax({
                        url: '{{route('client.blog.post.translationset', [$post->id, ''])}}/' + $('#lang').val(),
                        type: 'POST',
                        dataType: 'json',
                        data: {
                          title: $('#t_title').val(),
                    ...
                    $('#updateTranslation').click(function(){
                      $.ajax({
                        url: '{{route('client.blog.post.translationset', [$post->id, ''])}}/' + $('#te_lang').val(),
                        type: 'POST',
                        dataType: 'json',
                        data: {
                          title: $('#te_title').val(),
                    ...
                    $.ajax({
                      url: '{{route('client.blog.post.translations', [$post->id])}}',
                      type: 'GET',
                      dataType: 'json',
                      success: function(data)
                      {
