...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            ...
            <div class="col-sm-12">
                <a href="{{groute('blog.create')}}" class="btn btn-primary btn-lg pull-right">Add post</a>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <ul class="nav nav-tabs" id="toggles">
                            ...
                            <li><a data-toggle="tab" data-value="1" href="#un-my-posts">My posts</a></li>
                ...
                <script type="text/javascript">
                  $(document).ready(function() {
                    ...
                    var oTable = $('#posts-table').DataTable({
                      ...
                      ajax: {
                        url: '{!! route('blog.posts.dataquery') !!}',
                        method: 'GET',
                        data: function (d) {
                    ...
                    $('#toggles a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
                      only_my = $(e.target).data("value");
                      oTable.draw();
                    });
                  });
                </script>
