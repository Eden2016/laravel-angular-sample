<?php
$champions = \App\Models\Dota2\Champion::all();
?>
<div class="modal fade" id="dota2MatchGame">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <select name="opponent1_bans[]" id="opponent1_bans" class="select2" multiple
                                        style="width: 100%">
                                ...
                                @if($match->opponent1_details)
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_player1" id="opponent1_player1" class="select2"
                                                    style="width: 100%">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_player2" id="opponent1_player2" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent1_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_player3" id="opponent1_player3" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent1_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_player4" id="opponent1_player4" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent1_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_player5" id="opponent1_player5" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent1_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_picks1" id="opponent1_picks1" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_picks2" id="opponent1_picks2" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_picks3" id="opponent1_picks3" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_picks4" id="opponent1_picks4" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent1_picks5" id="opponent1_picks5" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <select name="opponent2_bans[]" id="opponent2_bans" class="select2" multiple
                                        style="width: 100%">
                                    @foreach($champions as $champ)
                                        <option value="{{$champ->id}}">{{$champ->name}}</option>
                                    @endforeach
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_player1" id="opponent2_player1" class="select2"
                                                    style="width: 100%">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_player2" id="opponent2_player2" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent2_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_player3" id="opponent2_player3" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent2_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_player4" id="opponent2_player4" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent2_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_player5" id="opponent2_player5" class="select2"
                                                    style="width: 100%">
                                                @foreach($match->opponent2_details->roster as $player)
                                                    <option value="{{$player->id}}">{{$player->nickname}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_picks1" id="opponent2_picks1" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_picks2" id="opponent2_picks2" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_picks3" id="opponent2_picks3" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_picks4" id="opponent2_picks4" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="opponent2_picks5" id="opponent2_picks5" class="select2"
                                                    style="width: 100%">
                                                <option></option>
                                                @foreach($champions as $champ)
                                                    <option value="{{$champ->id}}">{{$champ->name}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select ng-model="matchGameWinner" ng-options="i.value as i.label for i in teams"
                                        name="final_result" id="final_result" class="form-control">
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-match-id="" data-match-game-id=""
                        data-ng-click="saveDota2MatchGame()">Save changes
                </button>
            </div>
        </div>
        <!-- /.modal-content -->
