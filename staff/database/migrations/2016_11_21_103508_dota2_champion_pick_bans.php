...
class Dota2ChampionPickBans extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dota2_champion_picks', function (Blueprint $table) {
            $table->engine = 'InnoDB';
        ...
        Schema::create('dota2_champion_bans', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::drop('dota2_champion_picks');
        Schema::drop('dota2_champion_bans');
    }
}
