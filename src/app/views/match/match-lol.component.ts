...
@Component({
  selector: 'match-lol-page',
  templateUrl: './match-lol.component.html',
  styles: [`
   ...
   .lol-page .game-slider .slide .score-container .guest-team img {
     margin-right: auto;
   }
    
   .lol-page .game-slider .slide .score-container .guest-team:after {
     right:55px;
   }
...
export class MatchLolComponent implements OnInit {
